...
feature "User" do
  site = Site.create(id: 1, name: "Appful", user_id: 1, description: "Appful is an application that allows users to submit their app for review by the Appful community.", url: "www.appful.com")
